...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/jkanban/jkanban.min.css')); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="avatar m-0 mr-1">
                      <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" height="36" width="36"
...
<?php $__env->startSection('vendor-scripts'); ?>
  <script src="<?php echo e(asset('vendors/js/jkanban/jkanban.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/scripts/pages/app-kanban.js')); ?>"></script>   
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vrushank/Downloads/frest-admin-v2.1/larvel-version/full-version/resources/views/pages/app-kanban.blade.php ENDPATH**/ ?>