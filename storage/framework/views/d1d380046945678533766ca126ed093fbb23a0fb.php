          ...
          <div class="table-responsive">
            ...
            <table id="table-marketing-campaigns" class="table table-borderless table-marketing-campaigns mb-0">
              ...
              <tbody>
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/one-plus.png')); ?>" alt="card"
                ...
                <tr>
                  <td class="py-1 line-ellipsis">
                    <img class="rounded-circle mr-1" src="<?php echo e(asset('images/icon/google.png')); ?>" alt="card"
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/pages/dashboard-ecommerce.blade.php ENDPATH**/ ?>