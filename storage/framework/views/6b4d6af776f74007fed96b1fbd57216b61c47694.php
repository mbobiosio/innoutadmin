...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/tables/datatable/responsive.bootstrap.min.css')); ?>">
...
<section class="invoice-list-wrapper">
  ...
  <div class="invoice-create-btn mb-1">
    <a href="<?php echo e(asset('app-invoice-add')); ?>" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true"
      >Create Invoice</a
    >
  </div>
        ...
        <tr>
          ...
          <td>
            <div class="invoice-action">
              <a href="<?php echo e(asset('app-invoice-view')); ?>" class="invoice-action-view mr-1">
                <i class="bx bx-show-alt"></i>
              </a>
              <a href="<?php echo e(asset('app-invoice-edit')); ?>" class="invoice-action-edit cursor-pointer">
...
<script src="<?php echo e(asset('vendors/js/tables/datatable/responsive.bootstrap.min.js')); ?>"></script>  
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-scripts'); ?>
<script src="<?php echo e(asset('js/scripts/pages/app-invoice.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vrushank/Downloads/frest-admin-v2.1/larvel-version/full-version/resources/views/pages/app-invoice-list.blade.php ENDPATH**/ ?>