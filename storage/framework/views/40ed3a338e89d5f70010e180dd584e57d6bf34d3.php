      ...
      <div class="row match-height">
        <div class="col-md-4 col-sm-6 kb-search-content">
          <div class="card kb-hover-1">
            <div class="card-content">
              <div class="card-body text-center">
                <a href="<?php echo e(asset('page-knowledge-base/categories')); ?>">
                  <div class=" mb-1">
                    <i class="livicon-evo"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adesanoye/lampstack/frameworks/FrestLaravelDashboard/resources/views/pages/page-knowledge-base.blade.php ENDPATH**/ ?>