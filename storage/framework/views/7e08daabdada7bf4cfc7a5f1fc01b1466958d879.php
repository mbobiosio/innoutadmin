<?php $__env->startSection('title', 'App Calendar'); ?>

<?php $__env->startSection('vendor-styles'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/calendars/tui-time-picker.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/calendars/tui-date-picker.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/calendars/tui-calendar.min.css')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-styles'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/core/menu/menu-types/vertical-menu.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/calendars/app-calendar.css')); ?>">
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('vendors/js/calendar/tui-code-snippet.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/calendar/tui-dom.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/calendar/tui-time-picker.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/calendar/tui-date-picker.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/calendar/chance.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/calendar/tui-calendar.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php $__env->startSection('page-scripts'); ?>
<script src="<?php echo e(asset('js/scripts/extensions/calendar/calendars-data.js')); ?>"></script>
<script src="<?php echo e(asset('js/scripts/extensions/calendar/schedules.js')); ?>"></script>
<script src="<?php echo e(asset('js/scripts/extensions/calendar/app-calendar.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-html-laravel-template/resources/views/pages/app-calendar.blade.php ENDPATH**/ ?>