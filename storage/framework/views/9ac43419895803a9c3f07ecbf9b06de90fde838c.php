        ...
        <ul class="nav navbar-nav float-right">
              ...
              <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                ...
                <div class="d-flex justify-content-between cursor-pointer">
                  <div class="media d-flex align-items-center py-0">
                    <div class="media-left pr-0"><img class="mr-1" src="<?php echo e(asset('images/icon/sketch-mac-icon.png')); ?>" alt="avatar" height="39" width="39"></div>
                    <div class="media-body">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              <a class="dropdown-item" href="<?php echo e(asset('page-user-profile')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/panels/navbar.blade.php ENDPATH**/ ?>