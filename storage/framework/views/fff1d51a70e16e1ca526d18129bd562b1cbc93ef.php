          ...
          <div class="card-body pb-0 mx-25">
            ...
            <div class="row my-3">
              ...
              <div class="col-6 d-flex justify-content-end">
                <img src="<?php echo e(asset('images/pages/pixinvent-logo.png')); ?>" alt="logo" height="46" width="164">
              </div>
            </div>
            <hr>
    ...
    <div class="col-xl-3 col-md-4 col-12">
      <div class="card invoice-action-wrapper shadow-none border">
        <div class="card-body">
          ...
          <div class="invoice-action-btn">
            <a href="<?php echo e(asset('app-invoice-edit')); ?>" class="btn btn-light-primary btn-block">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vrushank/Downloads/frest-admin-v2.1/larvel-version/full-version/resources/views/pages/app-invoice.blade.php ENDPATH**/ ?>