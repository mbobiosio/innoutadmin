      ...
      <header class="d-flex justify-content-between align-items-center border-bottom px-1 py-75">
        <div class="d-flex align-items-center">
          ...
          <div class="avatar chat-profile-toggle m-0 mr-1">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-26.jpg')); ?>" alt="avatar" height="36" width="36" />
            <span class="avatar-status-busy"></span>
          </div>
          <h6 class="mb-0"><?php echo e($user->name); ?> <?php echo e($user->last_name); ?></h6>
        </div>
    ...
    <div class="card chat-wrapper shadow-none">
      ...
      <div class="card-footer chat-footer border-top px-2 pt-1 pb-0 mb-1">
        <form class="d-flex align-items-center" onsubmit="chatMessagesSend();" action="javascript:void(0);">
          ...
          <input type="hidden" name="message_id" value="<?php echo e($message_info->id); ?>" >
...
<section class="chat-profile">
  <header class="chat-profile-header text-center border-bottom">
    ...
    <div class="my-2">
      ...
      <h5 class="app-chat-user-name mb-0"><?php echo e($user->name); ?></h5>
      <span>Devloper</span>
    </div>
  </header>
...
function chatMessagesSend(source) {
  ...
  $.ajaxSetup({
    ...
    $.ajax({
        url: "<?php echo e(url('storeConversations')); ?>",
        method: 'post',
        data: {
  ...
  setInterval(function() {
    ...
    var authenticated_user = "<?php echo e(Auth::user()->id); ?>";
    $.ajax({
        url: "<?php echo e(url('getConversations')); ?>",
        method: "get",
        data: {
            id: value
        },
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adesanoye/lampstack/frameworks/innout admin/resources/views/pages/app-chat-show.blade.php ENDPATH**/ ?>