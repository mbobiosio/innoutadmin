<?php $__env->startSection('title','Miscellaneous'); ?>

<?php $__env->startSection('vendor-styles'); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/extensions/jquery.contextMenu.min.css')); ?>">
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/extensions/context-menu.css')); ?>">
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('vendors/js/extensions/jquery.contextMenu.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/toastr.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/idle-timer.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/numeral/numeral.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/js/extensions/numeral/locales.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-scripts'); ?>
<script src="<?php echo e(asset('js/scripts/extensions/ext-component-miscellaneous.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/frest/resources/views/pages/ext-component-miscellaneous.blade.php ENDPATH**/ ?>