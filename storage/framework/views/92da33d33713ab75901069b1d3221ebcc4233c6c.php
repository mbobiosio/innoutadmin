          ...
          <div class="chat-content">
            <div class="chat">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
            ...
            <div class="chat chat-left">
              <div class="chat-avatar">
                <a class="avatar m-0">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-26.jpg')); ?>" alt="avatar" height="36"
                    width="36" />
                </a>
              </div>
              <div class="chat-body">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-html-laravel-template/resources/views/pages/app-chat.blade.php ENDPATH**/ ?>