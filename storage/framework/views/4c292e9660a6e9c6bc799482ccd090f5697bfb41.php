      ...
      <div class="email-user-list list-group">
        <ul class="users-list-wrapper media-list">
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" alt="avtar img holder">
              </div>
            </div>
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-5.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-10.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media mail-read">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
          ...
          <li class="media">
            ...
            <div class="pr-50">
              <div class="avatar">
                <img class="rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>"
                  alt="Generic placeholder image">
              </div>
            </div>
            <div class="media-body">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/pages/app-email.blade.php ENDPATH**/ ?>