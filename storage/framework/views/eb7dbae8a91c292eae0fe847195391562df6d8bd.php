                    ...
                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                      ...
                      <div class="widget-todo-item-action d-flex align-items-center">
                        ...
                        <div class="avatar m-0 mr-50">
                          <img src="<?php echo e(asset('images/profile/user-uploads/social-2.jpg')); ?>" alt="img placeholder"
                            height="32" width="32">
                        </div>
                        <div class="dropdown">
                          <span
                  ...
                  <li class="widget-todo-item">
                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                      ...
                      <div class="widget-todo-item-action d-flex align-items-center">
                        ...
                        <div class="avatar m-0 mr-50">
                          <img src="<?php echo e(asset('images/profile/user-uploads/user-05.jpg')); ?>" alt="img placeholder"
                            height="32" width="32">
                        </div>
                        <div class="dropdown">
                          <span
              ...
              <ul class="widget-timeline mb-0">
                <li class="timeline-items timeline-icon-primary active">
                  ...
                  <div class="timeline-content">
                    <img src="<?php echo e(asset('images/icon/pdf.png')); ?>" alt="document" height="23" width="19"
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/pages/dashboard-analytics.blade.php ENDPATH**/ ?>