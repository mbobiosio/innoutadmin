        ...
        <div class="card-content">
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <!-- Buttons with Icon -->
                <button type="button" class="btn btn-outline-primary mr-1 mb-1"><i class="bx bx-home"></i>Home</button>
                <button type="button" class="btn btn-warning mr-1 mb-1" ><i class="bx bx-star"></i> Star</button>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/pages/component-buttons-basic.blade.php ENDPATH**/ ?>