                                            ...
                                            <div class="media-body mt-25">
                                                <div
                                                    ...
                                                    <button id="select-files"
                                                        class="btn btn-sm btn-light-primary ml-50 mb-50 mb-sm-0">Upload
                                                        new
                                                        photo</button>
                                                    <form hidden action="#" class="dropzone dropzone-area"
...
<script src="<?php echo e(asset('js/scripts/pages/page-account-settings.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-laravel-admin-template/resources/views/pages/page-account-settings.blade.php ENDPATH**/ ?>