...
<?php echo $__env->make('pages.app-todo-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <li class="todo-item" data-name="John Doe">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" alt="avatar" height="30"
                    width="30">
                </div>
          ...
          <li class="todo-item" data-name="Maria Garcia">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-4.jpg')); ?>" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75 warning'><i class="bx bx-star bxs-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Jamesh Jackson">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Marry Smith">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-12.jpg')); ?>" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
          ...
          <li class="todo-item" data-name="Maria Garcia">
            <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
              ...
              <div class="todo-item-action d-flex align-items-center">
                ...
                <div class="avatar ml-1">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-13.jpg')); ?>" alt="avatar" height="30"
                    width="30">
                </div>
                <a class='todo-item-favorite ml-75'><i class="bx bx-star"></i></a>
                <a class='todo-item-delete ml-75'><i class="bx bx-trash"></i></a>
...
<script src="<?php echo e(asset('js/scripts/pages/app-todo.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-html-laravel-template/resources/views/pages/app-todo.blade.php ENDPATH**/ ?>