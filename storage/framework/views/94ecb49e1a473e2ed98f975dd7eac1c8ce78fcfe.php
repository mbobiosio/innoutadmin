<?php $__env->startSection('title','noUiSlider'); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/extensions/noui-slider.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/core/colors/palette-noui.css')); ?>">
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('js/scripts/extensions/noui-slider.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/frest/resources/views/pages/ext-component-noui-slider.blade.php ENDPATH**/ ?>