<?php $__env->startSection('title','Drag & Drop'); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/extensions/drag-and-drop.css')); ?>">
<?php $__env->stopSection(); ?>
          ...
          <div class="card-body">
            ...
            <ul class="list-group" id="basic-list-group">
              <li class="list-group-item">
                <div class="media">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-12.jpg')); ?>" class="rounded-circle mr-2"
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-4.jpg')); ?>" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
...
<script src="<?php echo e(asset('js/scripts/extensions/drag-drop.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/frest/resources/views/pages/ext-component-drag-drop.blade.php ENDPATH**/ ?>