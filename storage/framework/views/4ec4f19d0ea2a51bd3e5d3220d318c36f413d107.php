...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/plugins/forms/wizard.css')); ?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      <div class="d-flex justify-content-between flex-wrap align-items-center">
                        <div class="vs-radio-con vs-radio-primary">
                          <img src="<?php echo e(asset('images/pages/bank.png')); ?>" alt="img-placeholder" height="40">
                  ...
                  <div class="col-12 d-flex">
                    <div class="paypal cursor-pointer d-flex align-items-center">
                      ...
                      <img src="<?php echo e(asset('images/pages/PayPal_logo.png')); ?>" alt="PayPal Logo">
                    </div>
                    <div class="googlepay cursor-pointer pl-1 d-flex align-items-center">
                      ...
                      <img src="<?php echo e(asset('images/pages/google-pay.png')); ?>" height="30" alt="google Logo">
                    </div>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/frest/resources/views/pages/form-wizard.blade.php ENDPATH**/ ?>