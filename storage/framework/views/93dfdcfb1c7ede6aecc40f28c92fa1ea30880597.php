        ...
        <ul class="nav navbar-nav float-right d-flex align-items-center">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="<?php echo e(asset('app-email')); ?>"><i class="bx bx-envelope mr-50"></i> My Inbox</a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-html-laravel-template/resources/views/panels/horizontal-navbar.blade.php ENDPATH**/ ?>