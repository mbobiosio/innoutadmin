  ...
  <div class="chat-sidebar card">
    ...
    <div class="chat-sidebar-list-wrapper pt-2">
      ...
      <ul class="chat-sidebar-list">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
      ...
      <ul class="chat-sidebar-list">
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-5.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-online"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-busy"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-14.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-online"></span>
            </div>
            <div class="chat-sidebar-name">
        ...
        <li>
          <div class="d-flex align-items-center">
            <div class="avatar m-0 mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" height="36"
                width="36" alt="sidebar user image">
              <span class="avatar-status-offline"></span>
            </div>
            <div class="chat-sidebar-name">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/frest-bootstrap-admin-template-html/frest-html-laravel-template/resources/views/pages/app-chat-sidebar.blade.php ENDPATH**/ ?>