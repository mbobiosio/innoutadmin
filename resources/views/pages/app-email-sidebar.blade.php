    ...
    <div class="email-app-menu">
      ...
      <div class="sidebar-menu-list">
        ...
        <div class="list-group list-group-messages">
          <a href="{{route('app.email')}}" class="list-group-item pt-0 active" id="inbox-menu">
        ...
        <div class="card-content">
          <div class="card-body pt-0">
            <div class="form-group pb-50">
              ...
              <input type="text" id="emailfrom" class="form-control" name="from" placeholder="{{Auth::user()->email}}" value="{{Auth::user()->email}}" disabled>
            </div>
